...
public class Lazy_Adapter_Custom_Listview extends BaseAdapter {
	...
	static class ViewHolder 
	{
        ...
        ViewHolder(View row)
        {
        	readlinks = (TextView) row.findViewById(R.id.txtSurahTafseerLink);	
			artist = (TextView) row.findViewById(R.id.artist);	
			title = (TextView) row.findViewById(R.id.title);	
			duration = (TextView) row.findViewById(R.id.duration);	
			thumbimage = (ImageView) row.findViewById(R.id.list_image);	 
        }
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		_holder.readlinks.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String surah_name = _holder.artist.getText().toString();
				//Log.d("mk", "string : "+s);
