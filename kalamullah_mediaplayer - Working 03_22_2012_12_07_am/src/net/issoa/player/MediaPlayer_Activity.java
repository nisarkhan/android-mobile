	...
	public class loadSurah_ListView extends AsyncTask<Void, Void, String> { 
		...
		protected void AppendSongsListArray(String data)
		{
			...
			for (int i = 0; i < nl.getLength(); i++) {
				...
				map.put(MyConstants.KEY_ID, SongsManager1.getValue(e, MyConstants.KEY_ID));
				map.put(MyConstants.KEY_TITLE_ARABIC, SongsManager1.getValue(e, MyConstants.KEY_TITLE_ARABIC));
				map.put(MyConstants.KEY_TITLE_ENGLISH, SongsManager1.getValue(e, MyConstants.KEY_TITLE_ENGLISH));
				map.put(MyConstants.KEY_AUDIO_URL, SongsManager1.getValue(e, MyConstants.KEY_AUDIO_URL));
				map.put(MyConstants.KEY_DURATION, SongsManager1.getValue(e, MyConstants.KEY_DURATION));
				map.put(MyConstants.KEY_THUMB_URL, SongsManager1.getValue(e, MyConstants.KEY_THUMB_URL));
