...
public class Media_Player_Activity extends Activity implements OnCompletionListener, SeekBar.OnSeekBarChangeListener {
	...
	protected Dialog onCreateDialog(int id) {
		switch (id) {
		case MyConstants.progress_bar_type:
	 ...
	 * */
	public class loadSurah_ListView extends AsyncTask<String, String, String> { 
		...
		protected void onPreExecute() {
			super.onPreExecute();
			showDialog(MyConstants.progress_bar_type);
		}
		...
		protected void onPostExecute(String result) {  
			...
			pDialog.dismiss(); 
			dismissDialog(MyConstants.progress_bar_type);
		}
			...
			if(xmlList == null || xmlList.length() == 0)  
			{
				try { 
		         ...
		         // Output stream to write file
		            //OutputStream output = new FileOutputStream(response.getEntity().toString());
