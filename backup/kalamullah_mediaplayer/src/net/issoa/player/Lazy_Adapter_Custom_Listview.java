...
import net.issoa.custom_listview.Image_Loader_Custom_Listview;
...
public class Lazy_Adapter_Custom_Listview extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setText(song.get(PlayListActivity.KEY_TITLE_ARABIC));
        artist.setText(song.get(PlayListActivity.KEY_TITLE_ENGLISH));
        duration.setText(song.get(PlayListActivity.KEY_DURATION));
        imageLoader.DisplayImage(song.get(PlayListActivity.KEY_THUMB_URL), thumb_image);
        return vi;
    }
}