...
public class Lazy_Adapter_Custom_Listview extends BaseAdapter {
	...
	static class ViewHolder 
	{
        ...
        void populateTitleEnglish(String r) {
        	title_e.setText(r);
        }
	...
	private int[] colors = new int[] { 0x674627, 0xFFFFFF };
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		_holder.populateTitleEnglish(_surahs.get(MyConstants.KEY_TITLE_ENGLISH));
		...
		_holder.readlinks.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String surah_name_a = _holder.title_a.getText().toString();
				//Log.d("mk", "string : "+s);
				Toast.makeText(v.getContext(), "You selected item #: " + surah_name_a, Toast.LENGTH_SHORT).show(); 
				
				 
				Intent i = new Intent(v.getContext(), Custom_Tafseer_Activity.class);   
				i.putExtra("position", position); 
				i.putExtra("surah_name_a", surah_name_a);  
